...
printfn "%A" (iToString(Instruction.Ret(LLVMtype.Basic("i32"),LLVMexpr.Register("r1"))))
printfn "%A" (iToString(Instruction.Br_uc("loopstart")))
printfn "%A" (iToString(Bri1(Register("r2"),"label1","label2")))
printfn "%A" (iToString(Store(Basic("i8"),Iconst(1),Register("r1"),Some("align 1"))))
printfn "%A" (iToString(Alloca("r1",Basic("i32"),Some("align 4"))))
printfn "%A" (iToString(Unaryop("r2","fneg",None,Basic("float"),Register("r1"))))
printfn "%A" (iToString(Cast("r2","bitcast",Pointer(Basic("i8")),Register("r1"),Pointer(Basic("i32")))))
printfn "%A" (iToString(Icmp("r2","sle",Basic("i32"),Register("r1"),Iconst(1))))
printfn "%A" (iToString(Fcmp("r2","oeq",Basic("float"),Fconst(4.0),Register("r1"))))
printfn "%A" (iToString(SelectTrue("r3",Basic("i32"),Register("r1"),Register("r2"))))
printfn "%A" (iToString(Phi2("r2",Basic("i32"),Iconst(1),"block1",Register("r1"),"block2")))
printfn "%A" (iToString(Phi("r3",Basic("i8"),[(Iconst(1),"bb1");(Iconst(2),"bb2");(Iconst(3),"bb3")])))
printfn "%A" (iToString(Call(Some("r1"),Basic("i64"),[],"factorial",[(Basic("i8"),Iconst(8))])))
printfn "%A" (iToString(Verbatim("; comments start with ; so you can add ; to end of line")))
printfn "%A" (iToString(Arrayindex("r2",9,Basic("i8"),Global("str1"),Iconst(0))))
printfn "%A" (iToString(Structfield("r2",Userstruct("bigstruct"),Register("r1"),Iconst(1)))) 
